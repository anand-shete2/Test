...
export const MaskContainer = ({ children, revealText, size = 10, revealSize = 600, className }) => {
  ...
  return (
    <motion.div
      ref={containerRef}
      className={cn("relative h-[80vh]", className)}
      animate={{
        backgroundColor: isHovered ? "var(#0f172a)" : "var(#ffffff)",
      }}
      transition={{
    ...
    >
      ...
      >
        ...
        <div
          ...
          className="relative z-20 mx-auto min-w-full text-center text-4xl font-bold"
        >
          {children}
        </div>
      </motion.div>
